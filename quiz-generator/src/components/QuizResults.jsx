                    ...
                    <div className="mb-2">
                      <div className="flex items-center space-x-2 mb-2">
                        ...
                        <span className={`text-xs px-2 py-1 rounded-full ${
                          isCorrect ? 'bg-emerald-100 text-emerald-700 dark:bg-emerald-900/30 dark:text-emerald-300' : 'bg-rose-100 text-rose-700 dark:bg-rose-900/30 dark:text-rose-300'
